...
function switchGame(g) {
    ...
    else if (g === "gartic") { if(welcomeText) welcomeText.innerText = "🎨 Neon Çizim (Gartic Modu)"; initGartic(); startActiveGame(); // <-- İŞTE BU SATIR: Moda geçer geçmez oyunu başlatacak!
}
